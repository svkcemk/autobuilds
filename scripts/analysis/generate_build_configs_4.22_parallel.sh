#!/usr/bin/env bash
# Generate AI-powered build configs for Camel 4.22 unproductized dependencies (PARALLEL VERSION)
...
echo "============================================================"
echo "AI-Powered Build Config Generator for Camel 4.22 (PARALLEL)"
echo "============================================================"
echo
...
process_artifact() {
    ...
    local output_file="$output_dir/${artifact_id}-${version}.yaml"
    local status_file="$output_dir/.tmp/${artifact_id}-${version}.status"
